...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin Panel | TH-Z</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Aplikasi Persediaan Helm THZ">
    <meta name="author" content="Jundi Alfaruqi" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          ...
          <span style="font-size:30px">TH-Zahra</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2020 - <a href="https://textcode.blogspot.com">M. Jundi Alfaruqi, S.Kom</a></strong>
      </footer>
    </div><!-- ./wrapper -->
